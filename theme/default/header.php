                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="headturbo-content">
                            <h1 class="pulse"><?php trans('Instantly Analyze Your Website'); ?></h1>
                            ...
                            <div class="input-group review">
                              <input type="text" autocomplete="off" spellcheck="false" class="form-control" placeholder="<?php trans('Enter URL to Analyze...'); ?>" name="url" />
                              <span class="input-group-btn"> <button class="btn btn-green" type="submit" id="review-btn"><span class="glyphicon glyphicon-search"></span> <?php trans('Test your site'); ?></button></span>
                            </div>
                            </form>                         
                        </div>
                    </div>
